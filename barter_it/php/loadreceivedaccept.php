...
if (isset($_POST['sellerid'])){
	...
	$sqlloadpropose = "SELECT * FROM `propose_table` INNER JOIN `item_table` ON propose_table.seller_item_id = item_table.item_id WHERE propose_table.seller_id = '$sellerid' AND propose_table.propose_status = 1";
}
